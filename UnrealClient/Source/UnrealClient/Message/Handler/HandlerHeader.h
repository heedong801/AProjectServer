...
{														
	...
	Dis.AddHandler(MessageId::SetCharacterStat, std::bind(&OnMessageProcess<ThreadHandlerSetCharacterStatMessage, SetCharacterStatMessage>, std::placeholders::_1, Inst, World));	
